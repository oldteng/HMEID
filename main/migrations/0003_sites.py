    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subfamily', models.CharField(db_index=True, max_length=20)),
                ('gene', models.CharField(db_index=True, max_length=20)),
                ('ensembl', models.CharField(db_index=True, max_length=20)),
                ('consequence', models.CharField(db_index=True, max_length=50)),
